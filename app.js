...
var durationsubmitButton = d3.select("#filter-btn-duration");
var durationinputField = d3.select("#durationname");
// select comments buttons
var commentssubmitButton = d3.select("#filter-btn-comments");
var commentsinputField = d3.select("#commentsname");
